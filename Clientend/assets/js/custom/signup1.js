...
`
   ...
   Confirm Password Not Match
    ...
    `
        ...
        sessionStorage.setItem("userid", regAcc.clientid)
        const username = `${firstname} ${lastname}`
        const sendemail = await sendEamil(email,username)
...
sendEamil = async (email,username) => {
    ...
    const mailtemplate = await document.getElementById("mailtemplate").innerHTML
    const sendmail = await axios.post("/mail/registersend", {
        email:email,
