...
db.collection("newcourse").limit(3).get().then((snap) => { 
  snap.forEach((doc) => {    
    if(doc.data()!==undefined){      
          document.getElementById('courses').innerHTML +=
            `<div class="col-lg-4 col-md-6 portfolio-item ${doc.data().type}" style="cursor: pointer;">
      <div class="portfolio-wrap courseimgdiv" id="${doc.id}" onclick='view(this.id)' style="background-image: url(${doc.data().thum});">
       
        <div class="overlay">${doc.data().title}</div>
