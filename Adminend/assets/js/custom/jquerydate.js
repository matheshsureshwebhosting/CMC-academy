...
Invoice.prototype = {
     ...
     */
    newRow: function () {
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn"><input type="number" class="form-control batch" placeholder="batch" ><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div></td><td><input class="form-control date" placeholder="date" type="date"> </td></tr>');
