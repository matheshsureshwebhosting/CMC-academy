...
Invoice.prototype = {
     ...
     */
    newRow: function () {
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn"><input type="text" class="form-control days" placeholder="Days" type="text"><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div></td><td><input class="form-control firstsession" placeholder="First sessions" type="text"> </td><td><input class="form-control secondsession" placeholder="Second sessions" type="text"></td><td><input class="form-control thirdsession" placeholder="Third sessions" type="text"></td><td><input class="form-control fourthsession" placeholder="Fourth sessions" type="text"></td></tr>');
