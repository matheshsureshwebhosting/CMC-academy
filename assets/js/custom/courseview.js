                                    ...
                                    <div class="card-block">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg mt-2 mt-lg-0">
                                                <select name="" id="">
                                                    <option value="${doc.data().startdate}">${doc.data().startdate}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <ul class="tab-group row">
                                            <li class="tab col-lg col-3 active" onclick="openCity(event, 'Eligibility')"><a
...
db.collection("newcourse").orderBy("date", "asc").get().then((snaps) => {
    snaps.forEach((docs) => {
        ...
        if (docs.data().courseid == courseid) {
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg mt-2 mt-lg-0">
                                            <select name="" id="">
                                                <option value="${docs.data().startdate}">${docs.data().startdate}</option>
                                            </select>
                                        </div>
                                    </div>
    ...
    `
            //     var elidata = `${docs.data().eligibility}`
            //     var finalelidata = elidata.split("\n");
            //     for (var i = 0; i < finalelidata.length; i++) {
            //         document.getElementById("eli1").innerHTML +=
            //             `  <li><i class="fas fa-angle-right mr-3"></i>${finalelidata[i]}</li>
            // `

            //     }
            //     var docdata = `${docs.data().documents}`
            //     var finaldocdata = docdata.split("\n");
            //     for (var i = 0; i < finaldocdata.length; i++) {
            ...
            //     }
            //     var dedata = `${docs.data().description}`
            //     var finaldedata = dedata.split("\n");
            //     for (var i = 0; i < finaldedata.length; i++) {
